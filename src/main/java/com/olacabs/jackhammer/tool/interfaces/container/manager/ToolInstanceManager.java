...
@Slf4j
public class ToolInstanceManager implements Managed {
    ...
    @Inject
    ToolInstanceCheck toolInstanceCheck;
    ...
    public void start() throws Exception {
        try {
            ...
            executor.scheduleAtFixedRate(toolInstanceCheck, initialDelay, period, TimeUnit.MINUTES);
        } catch (Throwable th) {
