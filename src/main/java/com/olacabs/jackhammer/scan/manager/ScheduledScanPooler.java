...
public class ScheduledScanPooler implements Managed {
    @Inject
    JackhammerConfiguration jackhammerConfiguration;

    @Inject
    ScheduledScanPicker scheduledScanPicker;
    ...
    public void start() throws Exception {
        ...
        executor.scheduleAtFixedRate(scheduledScanPicker, initialDelay, period, TimeUnit.SECONDS);
    }
