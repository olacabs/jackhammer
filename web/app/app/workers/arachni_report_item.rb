	...
	class ReportItem
		...
		def supported_tags
			[
				...
				# simple tags
				:name, :severity,:description,:references,
				:remedy_guidance,:request,:response
			]
		end
		...
		def method_missing(method, *args)
			...
			if method.to_s == 'request' || method.to_s == 'response'
				return cleanup_html(xml.xpath("./page/#{method}").text)
			end
